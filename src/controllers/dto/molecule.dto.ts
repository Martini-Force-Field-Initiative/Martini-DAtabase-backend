...
import { castStringTrueFalseToBoolean } from "./dto_base";
...
const CTER = ["neutral", "charged", "capped"] as const;
type AvailableCter = (typeof CTER)[number];

const NTER = ["neutral", "charged", "capped"] as const;
...
export type AvailableJobType = (typeof JOB_TYPE)[number];
