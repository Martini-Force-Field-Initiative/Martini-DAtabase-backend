...
import { methodNotAllowed, errorCatcher, cleanMulterFiles, sanitize, dumpStdFromDir } from '../../../helpers/simple';
import { informAdminFromNewMolecule } from '../../../helpers/database/mailing';
...
import { FileDto } from '../../dto/membraneBuilder.dto'; 
...
CreateMoleculeRouter.post('/', Uploader.fields([
  ...
  (async () => {  //console.log("HERE>>");console.log(req.files);
    logger.debug("[ROUTER-MOLECULE] Receive create request")
